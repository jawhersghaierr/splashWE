...
function TextEditor({onSave}) {
  ...
  return (
    <div className="App" style={{ maxWidth: editorConfig.width,height:editorConfig.height, margin: "0 auto" }}>
      <JoditEditor
        value={data}
        config={editorConfig}
        onChange={value => setContentSplash({...contentSplash,content:value})}
      />
    </div>
  );
}
