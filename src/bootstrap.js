...
const PageDashboard = () => (
  <Typography
    ...
    noWrap
    component="div"
    sx={{ padding: "15px 25px", color: "#003154" }}
  >
    <b>Dashboard Page</b>
  </Typography>
);
...
const HospiRemote = (props) => (
  <RemoteHospiApp store={store} {...props} />
);

const ConfigurationBase = () => <Configurations store={store} />;
const ListConfigurationBase = () => <ListConfiguration store={store} />;
const ConfigurationDetailsByIdBase = () => (
  <ConfigurationDetailsById store={store} />
);
