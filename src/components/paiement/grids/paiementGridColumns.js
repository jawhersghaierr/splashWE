...
export const columns = disciplines => [
    ...
    { field: 'numIdPs', headerName: 'N° de facturation PS / TC', flex: 2, renderCell },
    { field: 'provenance', headerName: 'Provenance', flex: 1, renderCell },
    { field: 'creationDate', headerName: 'Date de paiement', flex: 1, renderCell, valueGetter: ({value}) => (convertDate(value)) },
